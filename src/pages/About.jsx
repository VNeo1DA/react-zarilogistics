        ...
        <>
			<div id="hero" className="tablet-desktop frame">
				...
				<h1 className="overlay-Title">Zarilogistics Services<br/>
					...
					and below are the core ones:</h1> 
			</div>
            ...
            <main>
                <section className="logistics-services">
                    <div className="imports">
                        ...
                        />
                        <p>We control all aspects of cargo to and from anywhere in the world, 
					...
					<h4>WAREHOUSING</h4>
						<img 
                            ...
                            className="logistics-imgs" 
                        />
						<p>We supply general warehousing facilities, but consider ourselves as an exclusive 
                    ...
                    <h4>ROAD FREIGHT SERVICES</h4>
						<img 
                            ...
                            className="logistics-imgs"
                        />
                        <p>We offer cost effective road transportion with the aim of giving our customers 
                    ...
                    <img 
                        ...
                        className="logistics-imgs"
                    />
                    <p>We offer reliable and expedient ways to ship your goods, which work on 
                    ...
                    <div className="air-freight">
                        ...
                        <img 
                            ...
                            className="logistics-imgs"
                            />
                        <p>We provide custom-oriented air freight forwarding solutions on 
                    ...
                    <div className="rail-freight">
                        ...
                        <img 
                            ...
                            className="logistics-imgs"
                        />
                        <p>Letting us handle your rail freight transportation ensures you are provided with 
